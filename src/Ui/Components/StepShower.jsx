  ...
  return (
    <div className="mb-6 sm:mb-8 flex items-start justify-center">
      <article className={`w-1/3 ${step >= 1 ? "step" : ""}`}>
        <div className="line1 smooth-transition w-full h-[13px] bg-gray-300 "></div>
      ...
      <article className={`w-1/3 ${step >= 2 ? "step" : ""}`}>
        <div className="line2 smooth-transition w-full h-[13px] bg-gray-300 border-x-4 border-x-transparant"></div>
      ...
      <article className={`w-1/3 ${step >= 3 ? "step" : ""}`}>
        <div className="line3 smooth-transition w-full h-[13px] bg-gray-300 "></div>
